...
function loadTeamStats(jsonObj) {
	...
	document.getElementById("team-page-league-matches").innerHTML = jsonObj.stats.season.wins + '-' + jsonObj.stats.season.losses;
	document.getElementById("team-page-league-maps").innerHTML = '(' + jsonObj.stats.season.mapwins + '-' + jsonObj.stats.season.maplosses + '-' + jsonObj.stats.season.mapties + ')';
}
