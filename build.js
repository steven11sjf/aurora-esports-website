...
function build() {
	...
	.then(() => {
		...
		arr.push(new GWLDivisionSpreadsheet("GWL Season 5.5", "GWL_Season5.5", false, '1rjwOiKJDN82Zmre40ZcUiBOyZK39jhVRfM5g16alf4k', 19));
		arr.push(new GWLDivisionSpreadsheet("Aurora Season 1", "AOC_Season1", false, '1fzRdi0boBOGPrWmHBEUrSk3ve8_hLaNsNDrIwhZUy7o', 22));
		arr.push(new GWLDivisionSpreadsheet("Aurora Season 2", "AOC_Season2", true, '1W7mRUAcJ4fcYToYXJyhb7eKNwCz5EkQnFXyPyloeHRA', 24));
