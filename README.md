...
| Term | Definition |
| :--- | :--------- |
| Overwatch | A team based first-person shooter developed by Blizzard Entertainment |
| Heroes | Playable characters in Overwatch; each one has unique abilities and weapons |
| Roles | A general classification of heroes into three distinct categories: <br>Damage characters are good at dealing high damage and confirming eliminations. <br>Support characters can provide significant healing and abilities that assist other teammates. <br>Tank characters have a lot more health and tools such as barriers to draw aggression and help keep teammates alive. |
